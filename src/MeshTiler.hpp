...
protected:
  ...
  void prepareSettingsOfTile(MeshTile *tile, GDALDataset *dataset, const TileCoordinate &coord, const std::vector<float>& rasterHeights, ctb::i_tile tileSizeX, ctb::i_tile tileSizeY) const;
};

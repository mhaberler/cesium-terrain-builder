...
protected:
  ...
  void prepareSettingsOfTile(MeshTile *tile, GDALDataset *dataset, const TileCoordinate &coord, const float* rasterHeights, ctb::i_tile tileSizeX, ctb::i_tile tileSizeY) const;
};
